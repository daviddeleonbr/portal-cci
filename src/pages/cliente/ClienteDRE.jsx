...
export default function ClienteDRE() {
  ...
  if (!cliente.exibir_dre) {
    return (
      <div>
        <PageHeader title="DRE" description="Demonstracao do resultado do exercicio" />
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 text-sm text-amber-800 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700">
              O DRE ainda nao foi liberado pelo administrador da consultoria. Entre em contato
              se precisar visualizar este relatorio.
            </p>
          </div>
        </div>
      </div>

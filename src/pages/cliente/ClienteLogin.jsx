        ...
        >
          ...
          <Link to="/" className="flex items-center gap-2.5 mb-12 group w-fit">
            ...
            <div className="leading-none">
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest">Portal do Cliente</p>
            </div>
          </Link>
                  ...
                  {resposta?.ok && resposta.link && (
                    <div className="space-y-2">
                      ...
                      <p className="text-[10.5px] text-amber-300/80 leading-relaxed">
                        O envio automático por e-mail não está ativo no momento — copie o link e repasse pelo canal apropriado.
                      </p>
                    </div>
                  )}

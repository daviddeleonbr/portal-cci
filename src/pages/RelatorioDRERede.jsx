...
// DRE consolidada da rede: agrega todas as empresas Webposto de uma chave_api.
// Reusa o RelatorioDRE passando `redeContexto` com a lista de empresaCodigos.
export default function RelatorioDRERede() {

...
export default function LandingPortal() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 flex flex-col items-center justify-center px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              Gestao financeira, clientes, notas fiscais, boletos e parametrizacoes do escritorio.
            </p>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-500 mb-6 leading-relaxed">
              Relatorios, DRE, fluxo de caixa, servicos BPO, documentos e financeiro.
            </p>
      ...
      >
        CCI Consultoria Contabil - Todos os dados simulados para demonstracao
      </motion.p>
    </div>
  );
}

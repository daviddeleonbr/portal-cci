        ...
        >
          ...
          >
            ...
            <div className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-blue-500/10 text-blue-300 ring-1 ring-blue-400/20 mb-5 group-hover:bg-blue-500/20 group-hover:text-blue-200 group-hover:ring-blue-400/40 transition-all duration-300">

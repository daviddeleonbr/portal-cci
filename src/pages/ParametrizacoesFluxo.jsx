    ...
    <Modal open={open} onClose={onClose} title={data ? 'Editar Máscara' : 'Nova Máscara Fluxo de Caixa'} size="sm"
      footer={(
        <div className="flex justify-end gap-3">
          ...
          <button type="submit" form="form-mascara-fluxo" disabled={saving || !form.nome.trim()}
      ...
      <form id="form-mascara-fluxo" onSubmit={(e) => { e.preventDefault(); onSave(form); }} className="space-y-4">
        <div>

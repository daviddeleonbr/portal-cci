...
export const clienteDreData = {
  ...
  itens: [
    ...
    { id: 3, descricao: 'Serviços de Consultoria', nivel: 1, jan: 45000, fev: 48000, mar: 50500, tipo: 'receita' },
    { id: 4, descricao: 'Suporte e Manutenção', nivel: 1, jan: 20000, fev: 22000, mar: 22000, tipo: 'receita' },
    ...
    { id: 12, descricao: 'Salários e Encargos - Equipe Técnica', nivel: 1, jan: -52000, fev: -54000, mar: -56000, tipo: 'despesa' },
    ...
    { id: 17, descricao: 'Salários Administrativos', nivel: 1, jan: -22000, fev: -22000, mar: -23000, tipo: 'despesa' },
    ...
    { id: 22, descricao: '(-) Depreciação e Amortização', nivel: 0, jan: -3200, fev: -3200, mar: -3200, tipo: 'despesa' },
...
export const servicosBPO = [
  {
    id: 1,
    nome: 'BPO Financeiro',
    descricao: 'Gestão completa do contas a pagar e receber, conciliação bancária e controle de fluxo de caixa.',
    icone: 'wallet',
    status: 'ativo',
    responsavel: 'Ana Paula Santos',
    ultimaAtualizacao: '2026-03-24',
    tarefas: [
      { id: 1, titulo: 'Conciliação bancária - Março', status: 'concluido', data: '2026-03-22', responsavel: 'Ana Paula' },
      { id: 2, titulo: 'Lançamento de NFs recebidas', status: 'concluido', data: '2026-03-20', responsavel: 'Ana Paula' },
      { id: 3, titulo: 'Pagamento de fornecedores', status: 'em_andamento', data: '2026-03-25', responsavel: 'Ana Paula' },
      { id: 4, titulo: 'Relatório de inadimplencia', status: 'em_andamento', data: '2026-03-26', responsavel: 'Carlos Lima' },
  ...
  },
  {
    ...
    tarefas: [
      { id: 6, titulo: 'Escrituração contábil - Março', status: 'em_andamento', data: '2026-03-25', responsavel: 'Carlos Lima' },
      { id: 7, titulo: 'Balancete mensal - Fevereiro', status: 'concluido', data: '2026-03-10', responsavel: 'Carlos Lima' },
      { id: 8, titulo: 'SPED Contábil', status: 'concluido', data: '2026-03-15', responsavel: 'Juliana Ferreira' },
      { id: 9, titulo: 'Conciliação de contas patrimoniais', status: 'pendente', data: '2026-03-28', responsavel: 'Carlos Lima' },
  ...
  },
  {
    id: 3,
    nome: 'BPO Fiscal',
    descricao: 'Apuração de impostos, emissão de guias, entrega de obrigações acessórias e planejamento tributário.',
    icone: 'file-text',
    status: 'ativo',
    responsavel: 'Carlos Eduardo Lima',
    ultimaAtualizacao: '2026-03-22',
    tarefas: [
      { id: 11, titulo: 'Apuração PIS/COFINS - Março', status: 'em_andamento', data: '2026-03-25', responsavel: 'Carlos Lima' },
      { id: 12, titulo: 'Apuração ISS - Março', status: 'pendente', data: '2026-03-28', responsavel: 'Carlos Lima' },
      ...
      { id: 15, titulo: 'Emissão de guias DARF', status: 'concluido', data: '2026-03-18', responsavel: 'Carlos Lima' },
    ],
    indicadores: {
      guiasGeradas: 8,
  ...
  },
  {
    ...
    descricao: 'Folha de pagamento, admissoes, demissões, férias, benefícios e obrigações trabalhistas.',
    icone: 'users',
    status: 'ativo',
    responsavel: 'Roberto Mendes',
    ultimaAtualizacao: '2026-03-21',
    tarefas: [
      { id: 16, titulo: 'Processamento folha - Março', status: 'em_andamento', data: '2026-03-28', responsavel: 'Roberto Mendes' },
      { id: 17, titulo: 'Cálculo férias - 2 colaboradores', status: 'concluido', data: '2026-03-15', responsavel: 'Roberto Mendes' },
      ...
      { id: 20, titulo: 'Admissão novo colaborador', status: 'concluido', data: '2026-03-10', responsavel: 'Roberto Mendes' },
    ],
    indicadores: {
...
export const clienteDocumentos = [
  { id: 1, nome: 'Balancete - Fevereiro 2026', tipo: 'Contábil', data: '2026-03-10', formato: 'PDF', tamanho: '245 KB' },
  { id: 2, nome: 'DRE - Fevereiro 2026', tipo: 'Contábil', data: '2026-03-10', formato: 'PDF', tamanho: '180 KB' },
  { id: 3, nome: 'Guia DARF - PIS Março', tipo: 'Fiscal', data: '2026-03-18', formato: 'PDF', tamanho: '95 KB' },
  { id: 4, nome: 'Guia DARF - COFINS Março', tipo: 'Fiscal', data: '2026-03-18', formato: 'PDF', tamanho: '95 KB' },
  { id: 5, nome: 'Guia ISS - Março', tipo: 'Fiscal', data: '2026-03-18', formato: 'PDF', tamanho: '88 KB' },
  { id: 6, nome: 'Holerites - Fevereiro 2026', tipo: 'DP', data: '2026-03-05', formato: 'ZIP', tamanho: '1.2 MB' },
  { id: 7, nome: 'Recibo Férias - Joao Silva', tipo: 'DP', data: '2026-03-15', formato: 'PDF', tamanho: '110 KB' },
  { id: 8, nome: 'SPED Contábil - 2025', tipo: 'Contábil', data: '2026-03-15', formato: 'TXT', tamanho: '8.4 MB' },
...
export const clienteBoletos = [
  { id: 1, descricao: 'Mensalidade Contábil - Março/2026', valor: 4500.00, vencimento: '2026-03-10', pagamento: '2026-03-08', status: 'pago' },
  { id: 2, descricao: 'Mensalidade Contábil - Fevereiro/2026', valor: 4500.00, vencimento: '2026-02-10', pagamento: '2026-02-09', status: 'pago' },
  { id: 3, descricao: 'Mensalidade Contábil - Abril/2026', valor: 4500.00, vencimento: '2026-04-10', pagamento: null, status: 'pendente' },
  { id: 4, descricao: 'Consultoria Adicional - Abertura Filial', valor: 2200.00, vencimento: '2026-03-25', pagamento: null, status: 'pendente' },
  { id: 5, descricao: 'Mensalidade Contábil - Janeiro/2026', valor: 4500.00, vencimento: '2026-01-10', pagamento: '2026-01-10', status: 'pago' },
];

// ---------- Notificacoes ----------
export const clienteNotificacoes = [
  { id: 1, titulo: 'DRE de Fevereiro disponível', mensagem: 'O demonstrativo de resultado de Fevereiro/2026 já esta disponível para consulta.', data: '2026-03-10', lida: true, tipo: 'info' },
  { id: 2, titulo: 'Guias de impostos geradas', mensagem: 'As guias de PIS, COFINS e ISS de Março foram geradas e estao disponíveis em Documentos.', data: '2026-03-18', lida: false, tipo: 'alerta' },

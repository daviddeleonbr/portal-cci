...
| 4 | Segredos fora do navegador (IA/Quality/Asaas) | Reversível c/ flag | 🔶 4a-IA ✅ (proxy + Lote H `124`) · 4b-Asaas ✅ (admin-only, Lote H `125` — sem proxy) · 4c-Quality pendente (cliente lê `chaves_api.chave` → precisa de proxy) |
